...
begin
  ...
  // START
  FLogB[STATE_SC][0] := 0.0;
  FLogB[STATE_SC][1] := NEG_INF;
  FLogB[STATE_SC][2] := NEG_INF;
  FLogB[STATE_SC][3] := NEG_INF;

  // codon position 1
  FLogB[STATE_C1][0] := SafeLog(0.28);
  FLogB[STATE_C1][1] := SafeLog(0.22);
  FLogB[STATE_C1][2] := SafeLog(0.22);
  FLogB[STATE_C1][3] := SafeLog(0.28);
